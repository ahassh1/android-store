        ...
        <div className="card-body">
          ...
          <div className="card-actions justify-end">
            <Link to="/phone-details">
              <button className="rounded-md px-3.5 py-[9px] m-1 overflow-hidden relative group cursor-pointer border-2 font-medium border-indigo-600 shadow-gray-700 shadow-md">
